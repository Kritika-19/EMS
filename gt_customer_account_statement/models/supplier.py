...
class res_partner(models.Model):
    ...
    @api.depends('sup_filter_by','sup_period_from','sup_period_to',
                 'supplier_statement','sup_overdue_statement' )
    def _compute_sup_account_ids(self):
        for partner in self:
            ...
            if partner.sup_filter_by != False:    
                ...
                d1 = datetime.strptime(partner.sup_period_from, DEFAULT_SERVER_DATE_FORMAT)
                d2 = datetime.strptime(partner.sup_period_to, DEFAULT_SERVER_DATE_FORMAT)
